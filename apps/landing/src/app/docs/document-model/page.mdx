...
The email document is a plain JSON object. You can store it in any database, serialize it,
...
Each section is a horizontal row of the email. Sections contain one or more columns.
